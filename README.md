...
**R**eact - Biblioteca de UI baseada em componentes para Javascript -
**N**ode - Compilador e runtime Javascript no servidor 

Meu objetivo com essa aplicação a princípio era estudar Docker e eu queria explorá-lo a fundo, de modo que eu só poderia construir algo Full Stack.
...
Me pareceu uma boa oportunidade para estudar o TailwindCss. Ele me ganhou por me poupar da decisão arquitetural de manter arquivos CSS, que têm uma tendência a crescer desordenadamente.
